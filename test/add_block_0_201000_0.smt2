; add.block_0_201000.1 (0x201000) - Machine code write at 0x201000 is in unreserved stack space.
...
(define-fun on_stack ((a (_ BitVec 64)) (sz (_ BitVec 64))) Bool 
(let ((e (bvadd a sz))) (and (bvule stack_guard_min a) (bvule a e) (bvule e stack_max))))
...
(assert (not (mc_only_stack_range x86local_0 (_ bv8 64))))

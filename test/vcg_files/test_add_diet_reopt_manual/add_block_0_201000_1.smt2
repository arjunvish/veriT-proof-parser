; add.block_0_201000.1 (0x201004) - Machine code write at 0x201004 is in unreserved stack space.
...
(check-sat-assuming ((not (mc_only_stack_range x86local_1 (_ bv8 64)))))
(exit)

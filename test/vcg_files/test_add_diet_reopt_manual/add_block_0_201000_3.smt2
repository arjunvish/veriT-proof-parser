; add.block_0_201000.1 (0x20100c) - Machine code write at 0x20100c is in unreserved stack space.
...
(check-sat-assuming ((not (mc_only_stack_range x86local_4 (_ bv8 64)))))
(exit)

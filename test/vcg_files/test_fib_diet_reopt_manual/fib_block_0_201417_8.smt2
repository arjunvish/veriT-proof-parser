; fib.block_0_201417.0 (0x20141f) - jump precondition: (= (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 64)) (llvm t15))
...
(check-sat-assuming ((not (= (mem_readbv64 x86mem_1 (bvsub fnstart_rsp (_ bv16 64))) llvm_t4))))
(exit)

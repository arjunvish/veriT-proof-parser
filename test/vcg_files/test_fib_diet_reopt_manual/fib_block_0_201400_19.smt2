; fib.block_0_201400.4 (0x201411) - false branch precondition: (= rsp (bvsub stack_high (_ bv40 64)))
...
(check-sat-assuming ((not (=> (not (= llvm_t3 (_ bv1 1))) (= x86local_3 (bvsub fnstart_rsp (_ bv40 64)))))))
(exit)

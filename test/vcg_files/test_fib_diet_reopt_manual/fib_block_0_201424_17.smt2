; fib.block_0_201424.2 (0x20142f) - jump precondition: (= r15 (fnstart r15))
...
(assert (= (mem_readbv64 x86mem_0 (bvsub fnstart_rsp (_ bv24 64))) llvm_t5))
...
(define-fun llvm_t7 () (_ BitVec 64) a201434_rax)
; LLVM: br label %block_0_201434
(assert (= #x0000000000201434 a201434_rip))
(assert (= (_ bv7 3) a201434_x87top))
(assert (= false a201434_df))
(assert (= a201434_rbp (bvsub fnstart_rsp (_ bv8 64))))
(assert (= a201434_rsp (bvsub fnstart_rsp (_ bv40 64))))
(assert (= (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv8 64))) fnstart_rbp))
(assert (= (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv24 64))) llvm_t5))
(assert (= a201434_rax llvm_t7))
(assert (= a201434_rbx fnstart_rbx))
(assert (= a201434_r12 fnstart_r12))
(assert (= a201434_r13 fnstart_r13))
(assert (= a201434_r14 fnstart_r14))
(check-sat-assuming ((not (= a201434_r15 fnstart_r15))))
(exit)

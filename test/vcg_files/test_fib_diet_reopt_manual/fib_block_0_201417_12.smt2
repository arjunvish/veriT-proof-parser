; fib.block_0_201417.0 (0x20141f) - jump precondition: (= r14 (fnstart r14))
...
(assert (= (mem_readbv64 x86mem_1 (bvsub fnstart_rsp (_ bv16 64))) llvm_t4))
(assert (= a201417_rbx fnstart_rbx))
(assert (= a201417_r12 fnstart_r12))
(assert (= a201417_r13 fnstart_r13))
(check-sat-assuming ((not (= a201417_r14 fnstart_r14))))
(exit)

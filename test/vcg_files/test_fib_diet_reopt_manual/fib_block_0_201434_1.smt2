; fib.block_0_201434.1 (0x20143c) - Machine code write at 0x20143c is in unreserved stack space.
...
(check-sat-assuming ((not (mc_only_stack_range x86local_11 (_ bv8 64)))))
(exit)

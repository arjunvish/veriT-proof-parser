; fib.block_0_201400.4 (0x201408) - Machine code write at 0x201408 is in unreserved stack space.
...
(check-sat-assuming ((not (mc_only_stack_range x86local_8 (_ bv8 64)))))
(exit)

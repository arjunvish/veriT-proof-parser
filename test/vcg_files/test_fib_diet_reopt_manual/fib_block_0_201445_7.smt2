; fib.block_0_201445.1 (0x20144c) - jump precondition: (= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp))
...
(assert (= a201445_rbp (bvsub fnstart_rsp (_ bv8 64))))
(assert (= a201445_rsp (bvsub fnstart_rsp (_ bv40 64))))
(check-sat-assuming ((not (= (mem_readbv64 x86mem_1 (bvsub fnstart_rsp (_ bv8 64))) fnstart_rbp))))
(exit)

; fib.block_0_201434.1 (0x201440) - Check return address matches next instruction.
...
(check-sat-assuming ((distinct (mem_readbv64 x86mem_2 x86local_12) #x0000000000201445)))
(exit)

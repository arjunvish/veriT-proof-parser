; fib.block_0_201424.2 (0x20142f) - jump precondition: (= (mcstack (bvsub stack_high (_ bv24 64)) (_ BitVec 64)) (llvm t9))
...
(check-sat-assuming ((not (= (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv24 64))) llvm_t5))))
(exit)

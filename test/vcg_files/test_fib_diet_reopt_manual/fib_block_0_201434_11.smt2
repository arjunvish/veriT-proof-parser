; fib.block_0_201434.2 (0x201440) - jump precondition: (= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp))
...
(check-sat-assuming ((not (= (mem_readbv64 x86mem_3 (bvsub fnstart_rsp (_ bv8 64))) fnstart_rbp))))
(exit)

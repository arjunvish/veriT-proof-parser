; fib.block_0_201434.1 (0x201440) - Machine code write at 0x201440 is in unreserved stack space.
...
(check-sat-assuming ((not (mc_only_stack_range x86local_12 (_ bv8 64)))))
(exit)

; fib.block_0_201417.0 (0x20141b) - Machine code write at 0x20141b is in unreserved stack space.
...
(check-sat-assuming ((not (mc_only_stack_range x86local_2 (_ bv8 64)))))
(exit)

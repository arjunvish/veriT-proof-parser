; fib.block_0_201445.1 (0x20144c) - jump precondition: (= (mcstack (bvsub stack_high (_ bv16 64)) (_ BitVec 64)) (llvm t15))
...
(check-sat-assuming ((not (= (mem_readbv64 x86mem_1 (bvsub fnstart_rsp (_ bv16 64))) llvm_t14))))
(exit)

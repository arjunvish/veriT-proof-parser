; fib.block_0_201400.4 (0x201411) - true branch precondition: (= (mcstack (bvsub stack_high (_ bv24 64)) (_ BitVec 64)) (llvm t5))
...
(check-sat-assuming ((not (=> (= llvm_t3 (_ bv1 1)) (= (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv24 64))) llvm_arg0)))))
(exit)

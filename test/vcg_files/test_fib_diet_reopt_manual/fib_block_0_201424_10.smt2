; fib.block_0_201424.2 (0x20142f) - jump precondition: (= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp))
...
(check-sat-assuming ((not (= (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv8 64))) fnstart_rbp))))
(exit)

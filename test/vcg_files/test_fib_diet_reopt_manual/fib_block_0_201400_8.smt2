; fib.block_0_201400.4 (0x201411) - true branch precondition: (= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp))
...
(check-sat-assuming ((not (=> (= llvm_t3 (_ bv1 1)) (= (mem_readbv64 x86mem_2 (bvsub fnstart_rsp (_ bv8 64))) fnstart_rbp)))))
(exit)

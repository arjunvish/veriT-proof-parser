; fib.block_0_201434.2 (0x201440) - jump precondition: (= (mcstack (bvsub stack_high (_ bv32 64)) (_ BitVec 64)) (llvm t13))
...
(check-sat-assuming ((not (= (mem_readbv64 x86mem_3 (bvsub fnstart_rsp (_ bv32 64))) llvm_t8))))
(exit)

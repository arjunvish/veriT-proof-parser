; fib.1.5 (0x201411) - false branch precondition: (= rbp (bvsub stack_high (_ bv8 64)))
...
(check-sat-assuming ((not (=> (not (= llvm_5 (_ bv1 1))) (= x86local_0 (bvsub fnstart_rsp (_ bv8 64)))))))
(exit)

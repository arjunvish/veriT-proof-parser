; fib.6.1 (0x20141b) - LLVM and machine code write to same allocation offset.
...
(check-sat-assuming ((distinct (bvsub llvm_2 llvm_2) (bvsub x86local_2 alloca_2_mc_base))))
(exit)

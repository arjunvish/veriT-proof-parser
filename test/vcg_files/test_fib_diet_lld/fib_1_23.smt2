; fib.1.5 (0x201411) - false branch precondition: (= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp))
...
(check-sat-assuming ((not (=> (not (= llvm_5 (_ bv1 1))) (= (mem_readbv64 x86mem_1 (bvsub fnstart_rsp (_ bv8 64))) fnstart_rbp)))))
(exit)

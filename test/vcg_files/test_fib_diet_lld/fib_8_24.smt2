; fib.8.8 (0x20144c) - jump precondition: (= (mcstack (bvsub stack_high (_ bv8 64)) (_ BitVec 64)) (fnstart rbp))
...
(check-sat-assuming ((not (= (mem_readbv64 x86mem_5 (bvsub fnstart_rsp (_ bv8 64))) fnstart_rbp))))
(exit)

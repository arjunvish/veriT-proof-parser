; fib.1.5 (0x201411) - false branch precondition: (= r15 (fnstart r15))
...
(assert (=> (not (= llvm_5 (_ bv1 1))) (= false false)))
(assert (=> (not (= llvm_5 (_ bv1 1))) (= x86local_0 (bvsub fnstart_rsp (_ bv8 64)))))
(assert (=> (not (= llvm_5 (_ bv1 1))) (= x86local_3 (bvsub fnstart_rsp (_ bv40 64)))))
(assert (=> (not (= llvm_5 (_ bv1 1))) (= (mem_readbv64 x86mem_1 (bvsub fnstart_rsp (_ bv8 64))) fnstart_rbp)))
(assert (=> (not (= llvm_5 (_ bv1 1))) (= a201400_rbx fnstart_rbx)))
(assert (=> (not (= llvm_5 (_ bv1 1))) (= a201400_r12 fnstart_r12)))
(assert (=> (not (= llvm_5 (_ bv1 1))) (= a201400_r13 fnstart_r13)))
(assert (=> (not (= llvm_5 (_ bv1 1))) (= a201400_r14 fnstart_r14)))
(check-sat-assuming ((not (=> (not (= llvm_5 (_ bv1 1))) (= a201400_r15 fnstart_r15)))))
(exit)

; fib.16.1 (0x201459) - Value of r13 at return is preserved.
...
(assert (= x86local_12 (bvadd fnstart_rsp (_ bv8 64))))
(assert (= x86local_11 return_addr))
(assert (= x86local_9 fnstart_rbp))
(assert (= a201450_rbx fnstart_rbx))
(assert (= a201450_r12 fnstart_r12))
(check-sat-assuming ((distinct a201450_r13 fnstart_r13)))
(exit)

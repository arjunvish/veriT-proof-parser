; fib.6.0 (0x201417) - LLVM and machine code read from same allocation offset.
...
(check-sat-assuming ((distinct (bvsub llvm_3 alloca_3_llvm_base) (bvsub x86local_0 alloca_3_mc_base))))
(exit)

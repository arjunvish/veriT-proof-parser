; fib.16.0 (0x201450) - LLVM and machine code read from same allocation offset.
...
(check-sat-assuming ((distinct (bvsub llvm_2 alloca_2_llvm_base) (bvsub x86local_0 alloca_2_mc_base))))
(exit)

; fib.1.2 (0x201408) - LLVM and machine code write to same allocation offset.
...
(check-sat-assuming ((distinct (bvsub llvm_3 llvm_3) (bvsub x86local_8 alloca_3_mc_base))))
(exit)

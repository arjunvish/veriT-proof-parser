; fib.1.3 (0x20140c) - LLVM and machine code read from same allocation offset.
...
(check-sat-assuming ((distinct (bvsub llvm_3 alloca_3_llvm_base) (bvsub x86local_9 alloca_3_mc_base))))
(exit)

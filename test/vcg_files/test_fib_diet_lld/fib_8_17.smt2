; fib.8.7 (0x20144c) - LLVM and machine code write to same allocation offset.
...
(check-sat-assuming ((distinct (bvsub llvm_2 llvm_2) (bvsub x86local_37 alloca_2_mc_base))))
(exit)
